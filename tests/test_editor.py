...
class TestEditor:
    ...
    def test_assemble_success(
        self, temp_dir, sample_audio_file, sample_video_file, sample_ass_file, mock_ffmpeg_probe, mock_ffmpeg_success
    ):
    ...
    def test_assemble_missing_ass_file(self, temp_dir, sample_audio_file, sample_video_file):
    ...
    def test_assemble_missing_audio_file(self, temp_dir, sample_ass_file, sample_video_file):
    ...
    def test_assemble_missing_media_file(self, temp_dir, sample_ass_file, sample_audio_file):
    ...
    def test_assemble_invalid_duration(self, temp_dir, sample_ass_file, sample_audio_file, sample_video_file, monkeypatch):
    ...
    def test_assemble_ffmpeg_failure(self, temp_dir, sample_ass_file, sample_audio_file, sample_video_file, mock_ffmpeg_probe, monkeypatch):
