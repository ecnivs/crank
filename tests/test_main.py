...
class TestCore:
    ...
    @patch("main.Orchestrator")
    @patch("main.genai.Client")
    def test_time_left_no_limit(self, mock_client_class, mock_orchestrator_class, mock_scraper_class, 
                                 mock_gemini_class, mock_handler_class, mock_editor_class, 
                                 mock_uploader_class, temp_preset_file, temp_dir):
