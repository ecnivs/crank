...
class TestCaptionHandler:
    ...
    @patch("spacy.load")
    @patch("caption.caption.SpeechToText")
    def test_get_captions_success(self, mock_stt_class, mock_spacy_load, temp_dir, sample_audio_file):
    ...
    @patch("spacy.load")
    @patch("caption.caption.SpeechToText")
    def test_get_captions_missing_audio(self, mock_stt_class, mock_spacy_load, temp_dir):
    ...
    @patch("spacy.load")
    @patch("caption.caption.SpeechToText")
    def test_get_captions_no_words(self, mock_stt_class, mock_spacy_load, temp_dir, sample_audio_file):
